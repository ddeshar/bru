...
function BasicTable($header,$data)
{
  ...
  {
    $this->Cell(15,6,$eachResult["mem_id"],1,0,'C');
    $this->Cell(60,6,$eachResult["mem_name"],1,0,'C');
    $this->Cell(30,6,$eachResult["mem_birthday"],1,0,'C');
    $this->Cell(30,6 ,$eachResult["mem_address"],1,0,'C');
    $this->Cell(30,6 ,$eachResult["mem_tel"],1,0,'C');
    $this->Cell(30,6 ,$eachResult["status_mem"],1,0,'C');
	  $this->Ln();
   }
}
...
$header=array('รหัส','ชื่อ - สกุล','ว/ด/ป เกิด','ที่อยู่','เบอร์โทรศัพท์','สถานะ');
//Data loading
