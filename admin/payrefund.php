                            ...
                            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample_editable_1" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th>รหัสสมาชิก</th>
                                        <th>ชื่อ-สกุล</th>
                                        <th><div align='center'>เงินต้น</div></th>
                                        <th><center>ชำระเงินกู้</center></th>
...
?>
                <tr>
                  <td><?php echo $i++;?></td>
                    ...
                    <td align='center'><a href='admin_refunds_add.php?pay_id=<?=$pay_id?>' class="btn btn-responsive button-alignment btn-success"><i class='fa  fa-money'> ชำระเงิน</i></a>
                </tr>
									</tr>
                  <?php
							}
