...
<html lang="en">
    ...
    <body >
        ...
        <!-- Navigation -->
          ...
          <li class="nav-item">
          <a class="nav-link" href="index_page/data.php">ข้อมูล</a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="index_page/knowledge.php">กฎหมายและระเบียบ</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="index_page/contact.php">ติดต่อ</a>
          </li>
