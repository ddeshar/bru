...
if (isset($_GET["mem_id"])) {
		...
		$sql = "SELECT * FROM member
						...
						LEFT JOIN stop_member
						ON member.mem_id = stop_member.mem_id
...
<aside class="right-side">
    ...
    <!--section ends-->
									...
									<!-- <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
										...
										<div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
												<div class="container">
													...
													<label class="col-md-5 control-label" for="id">วันที่ยกเลิกบัญชี</label><p><?=$stop_date?></p>
		...
		<div align='center' class="error-actions">
				<a href="admin_stopmember_add.php" class="btn btn-primary btn-lg"><span class="fa fa-reply"></span> ถอยกลับ </a>
		</div>
</aside>
<!-- right-side -->
<?php
...
<script type="text/javascript">
  ...
  $('#test_print').click(function(){
    var view_open = window.open('stopmember_view_print.php?mem_id=' + mem_id,'Print-Window','width=1024,height=768,top=100,left=100');
    view_open.print();
  });
</script>
