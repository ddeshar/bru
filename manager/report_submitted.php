         ...
         <div class="col-md-12">
             ...
             <div class="portlet box default">
                    <div class="panel panel-default">
                        ...
                        <h3 style="color:black"><i class="fa fa-book"></i> <!-- InstanceBeginEditable name="หัวตาราง" --><center>รายงานข้อมูลการยื่นกู้</center><!-- InstanceEndEditable --></h3>
                        </div>
...
<center>
<a href="report_submitted_print.php?startdate=<?php echo $startdate; ?>&enddate=<?php echo $enddate;?>"><img src="asset/img/printer.png" width="100"></a>  <?php //code ปริ้น   ?>
</center>
</div>
</div>
</div>
