...
<aside class="right-side">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box success">
                  ...
                  ON refund.mem_id=member.mem_id WHERE date(ref_date)=curdate()";
    							$result = mysqli_query($link, $sql);
    ...
    ?>
                    <tr>
                        ...
                        <td align='center'>
                        <!-- <a href='admin_refund_view.php?ref_id=<?//=$ref_id?>' class='btn info btn-xs purple'><i class='fa fa-eye'></i></a> | -->
