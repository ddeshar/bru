											...
											<table class="table table-striped">
													<thead>
														<tr>
															...
															<th>รหัสสมาชิก</th>
															<th>ชื่อสมาชิก</th>
															<th><div align ='right'>จำนวนเงินกู้</div></th>
															<th><div align ='right'>ชำระ</div></th>
															<th><div align ='right'>คงเหลือ</div></th>
...
?>
                                      ...
                                      <td><?=$ref_date?></td>
																			<td><?=$mem_id?></td>
																			<td><?=$mem_name?></td>
																			<td align="right"><?php echo number_format($sub_moneyloan);?></td>
