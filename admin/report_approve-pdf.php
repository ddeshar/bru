...
function BasicTable($header,$data)
{
  ...
  {
    $this->Cell(30,6,$eachResult["sub_id"],1,0,'C');
    $this->Cell(30,6,$eachResult["mem_id"],1,0,'C');
    $this->Cell(30,6,$eachResult["mem_name"],1,0,'C');
    $this->Cell(30,6,$eachResult["sub_moneyloan"],1,0,'C');
    $this->Cell(30,6,$eachResult["sub_date"],1,0,'C');
    $this->Cell(30,6,$eachResult["status_app"],1,0,'C');
...
$header=array('รหัสการยื่นกู้','รหัสสมาชิก','ชื่อ - สกุล','จำนวนเงินที่ขอกู้','วันที่ขอกู็','สถานะการอนุมัติ');
//Data loading
...
$strSQL = "SELECT * FROM submitted left JOIN statusb_app ON submitted.id_sapp = statusb_app.id_sapp ";
...
$pdf->Ln(25);
$pdf->Cell(0,20,iconv( 'UTF-8','TIS-620','รายงานการอนุมัติเงินกู้'),0,1,"C");
