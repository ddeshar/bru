...
<head>
<meta charset="utf-8">
<meta http-equiv="refresh" content="1;url=report_submitted.php"> <?php //code ปริ้น   ?>
...
<center><img src="asset/img/logos.png" width="90" /></center>
				...
				<center><font face = "TH SarabunPSK", size="6"><b>รายงานข้อมูลการยื่นกู้</b></font></center>
        ...
        <table border="1" align="center" width="1000"  cellpadding="0"   cellspacing="0">
                                    ...
                                    WHERE submitted.sub_date BETWEEN '$startdate' AND '$enddate'
                                    GROUP BY
...
$sum_sub_moneyloan = $sum_sub_moneyloan + $row["sub_moneyloan"];
//ราคารวมทั้งหมด
$i++; }
...
<td align="right" class="style3"><b> <?php echo  number_format("$sum_sub_moneyloan",2)?>&nbsp;&nbsp;บาท</td>
<td></td>
</tfoot>
</body>
</html>
