...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
          ข้อมูลการทำสัญญากู้เงินกองทุนหมู่บ้าน
        </h1>
        <ol class="breadcrumb">
            <li>
                ...
                <div class="portlet box info">
                    <div class="portlet-title">
                        <div class="caption"> <i class="livicon" data-name="edit" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                          ตารางข้อมูลการทำสัญญากู้เงินกองทุนหมู่บ้าน
                        </div>
                    </div>
                    ...
                    <td align='center'><a href='admin_promise_view2.php?pro_id=<?=$pro_id?>' class='btn info btn-xs purple'><i class='fa fa-eye'></i></a>
