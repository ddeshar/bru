            ...
            <div class="panel panel-info">
                ...
                <div class="row">
									<!-- <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
										...
										<div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
												<div class="container">
													...
													<label class="col-md-5 control-label" for="id">วันที่ครบกำหนดส่ง</label><p><?php $strDate = "$pro_redate";	echo DateThai($strDate);?></p>
													<label class="col-md-5 control-label" for="id">วันที่จ่ายเงินกู้</label><p><?php $strDate = "$pay_date";	echo DateThai($strDate);?></p>
                    ...
                    <div class="pull-right" style="margin:10px 20px;">
										...
										<div class="pull-right" style="margin:10px 20px;">
                    <div class="btn-group pull-right">
                    <a href="report_repayments.php"class="btn dropdown-toggle btn-custom"><span class="fa fa-reply"></span> ถอยกลับ </a>
                  <div>
                  </div>
                </div>
            </div>
